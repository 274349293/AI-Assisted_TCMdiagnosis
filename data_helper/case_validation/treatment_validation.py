...
def main():
    """主函数"""
    input_file = '../../data/case_data/819-821-yy.xlsx'  # 输入文件路径
    output_file = '../../data/result/treatment_validation_results_819-821-yy.xlsx'  # 问题记录输出文件
    error_log_file = '../../data/result/treatment_validation_results_819-821-xs.log'  # 异常日志输出文件
